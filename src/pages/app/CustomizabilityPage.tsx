...
import { usePreferences, ACCENT_PRESETS, COLOR_SCHEMES, type ColorScheme } from "../../contexts/PreferencesContext";
...
export function CustomizabilityPage() {
	const { colorScheme, accentColor, setPreferences } = usePreferences();
