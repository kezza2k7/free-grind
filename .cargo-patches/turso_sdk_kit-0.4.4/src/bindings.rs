...
const _: () = {
    let _ = ::std::mem::size_of::<turso_slice_ref_t>();
    let _ = ::std::mem::align_of::<turso_slice_ref_t>();
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    let _ = ::std::mem::size_of::<turso_log_t>();
    let _ = ::std::mem::align_of::<turso_log_t>();
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    let _ = ::std::mem::size_of::<turso_config_t>();
    let _ = ::std::mem::align_of::<turso_config_t>();
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    let _ = ::std::mem::size_of::<turso_database_config_t>();
    let _ = ::std::mem::align_of::<turso_database_config_t>();
